...
class News extends CmsBase
{
    public function index($category='')
    {
        ...
        $this->setMobileTheme('article-list');$this->setMobileSection('news');$this->assignPageViewModel($vm);$this->applyMobileChannelFromViewModel($vm,'news');
    ...
    public function detail($slug='')
    {
        ...
        $this->setMobileTheme('article-detail');$this->setMobileSection('news');$this->assignPageViewModel($vm);$this->applyMobileChannelFromViewModel($vm,'news');
