...
class News extends CmsBase
{
    public function index($category='')
    {
        ...
        $this->setPcTheme('article-list','news','pc-news');$this->assignPageViewModel($vm);$this->applyChannelFromViewModel($vm,$category?:'新闻动态','/news');
    ...
    public function detail($slug='')
    {
        ...
        $this->setPcTheme('article-detail','news','pc-news-detail');$this->assignPageViewModel($vm);$this->applyChannelFromViewModel($vm,'新闻动态','/news');
