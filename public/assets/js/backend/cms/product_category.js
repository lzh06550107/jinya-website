define(['jquery','bootstrap','backend','table','form'],function($,undefined,Backend,Table,Form){
    ...
    var Controller={
        index:function(){
            Table.api.init({extend:{index_url:'cms/product_category/index',add_url:'cms/product_category/add',edit_url:'cms/product_category/edit',del_url:'cms/product_category/del',multi_url:'cms/product_category/multi'}});
            var table=$('#table');
